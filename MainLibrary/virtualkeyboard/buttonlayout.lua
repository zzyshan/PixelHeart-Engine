...
local function PlaceButton(spr, position, id, scale)
    ...
    button:SetAlpha(0.6)
    button:SetScale(scale[1] or 5, scale[2] or 5)
...
------------创建按钮----------------
PlaceArrow("virtualkeyboard/buttons/arrow-down.png", {570,420}, "down")
PlaceArrow("virtualkeyboard/buttons/arrow-up.png", {570,250}, "up")
PlaceArrow("virtualkeyboard/buttons/arrow-left.png", {0,360}, "left")
PlaceArrow("virtualkeyboard/buttons/arrow-right.png", {170,360}, "right")

PlaceButton("virtualkeyboard/buttons/button-z.png", {480,120}, "z", {3.5,3.5})
PlaceButton("virtualkeyboard/buttons/button-x.png", {580,120}, "x", {3.5,3.5})
PlaceButton("virtualkeyboard/buttons/button-c.png", {680,120}, "c", {3.5,3.5})
------------创建按钮----------------
        ...
        if touch.state ~= -1 then
            ...
            if closestArrow then
                if Keyboard.getState(closestArrow.id) == 0 then
                    ...
                    Keyboard.setState(closestArrow.id, 1)
                    closestArrow:Set("virtualkeyboard/buttons/"..closestArrow.BLtype.."-" .. closestArrow.id .. "1.png")
                    closestArrow.istouch = true
                elseif Keyboard.getState(closestArrow.id) == 1 then
                    Keyboard.setState(closestArrow.id, 2)
                end
            end
        end
    end
