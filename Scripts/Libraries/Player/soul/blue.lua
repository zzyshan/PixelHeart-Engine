...
function blue.update(dt)
    ...
    if Player.canmove then
        ...
        if var.direction == "down" then
            ...
            if input.isKeyDown("up") and var.canjump then
        ...
        elseif var.direction == "up" then
            ...
            if input.isKeyDown("down") and var.canjump then
                var.currentspeed = var.maxspeed
                var.canjump = false
                var.jumping = true
            end
        ...
        elseif var.direction == "left" then
            ...
            if input.isKeyDown("right") and var.canjump then
                var.currentspeed = var.maxspeed
                var.canjump = false
                var.jumping = true
            end
        ...
        elseif var.direction == "right" then
            ...
            if input.isKeyDown("left") and var.canjump then
                var.currentspeed = var.maxspeed
                var.canjump = false
                var.jumping = true
            end
